          ...
          <div className="projects__card">
            ...
            <div className="projects__card-info">
              ...
              <p className="projects__project-description">
                ...
                dolorem sint iure hic nostrum nulla sed! Voluptas amet, adipisci
                sit dolorem inventore quae accusamus error doloribus fuga quidem
                accusantium quas.
              </p>
              <div className="projects__project-tech">
                ...
                <span className="projects__project-tech-badge">javascript</span>
