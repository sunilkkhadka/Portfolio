            ...
            <div className="experiences__item">
              <div className="experiences__info">
                ...
                <div className="experiences__work-description">
                  ...
                  onboarding using React.js and TypeScript. Boosted performance
                  by integrating RESTful APIs with React Query, reducing API
                  calls. Contributed to planning and documenting client
                  features, ensuring clear requirements and efficient
                  development.
                </div>
            ...
            <div className="experiences__item">
              <div className="experiences__info">
                ...
                <div className="experiences__work-description">
                  ...
                  ensuring adaptability across all screen sizes. Optimized
                  loading speed by 70% through image compression, format
                  conversion, and lazy-loading. Integrated Google Analytics via
                  Tag Manager to track traffic and user activity.
                </div>
                <div className="experiences__tech-badges">
                  <p>Tools used:</p>
                  <img
